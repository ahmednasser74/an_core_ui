...
class AppLoadMoreWidget extends StatefulWidget {
  ...
  @override
  _AppLoadMoreWidgetState createState() => _AppLoadMoreWidgetState();
}

class _AppLoadMoreWidgetState extends State<AppLoadMoreWidget> {
  Widget get child => widget.child;

  LoadMoreDelegate get loadMoreDelegate => widget.delegate ?? AppLoadMoreWidget.buildDelegate();
  ...
  String Function(LoadMoreStatus) get buildLang => context.languageIsAr ? DefaultLoadMoreTextBuilder.arabic : DefaultLoadMoreTextBuilder.english;
      ...
      child: NotificationListener<_BuildNotify>(
        child: NotificationListener<ScrollNotification>(
          ...
          child: DefaultLoadMoreView(
            ...
            textBuilder: widget.textBuilder ?? buildLang,
          ),
        ),
